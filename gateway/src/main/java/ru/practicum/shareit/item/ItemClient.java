...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> searchItems(String text, Integer from, Integer size, int userId) {
        Map<String, Object> parameters = Map.of(
                "text", text,
                "from", from,
                "size", size
    ...
    public ResponseEntity<Object> createComment(CommentDto comment, int itemId, int userId) {
